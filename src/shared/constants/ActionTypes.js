...
export const GET_ARTIST_CONTACT_LIST = 'get_artist_contact_list';
export const UPDATE_ARTIST_CONTACT_DETAIL = 'UPDATE_ARTIST_CONTACT_DETAIL';
export const DELETE_ARTIST_CONTACT = 'DELETE_ARTIST_CONTACT';
export const CREATE_NEW_ARTIST_CONTACT = 'CREATE_NEW_ARTIST_CONTACT';

export const GET_ARTIST_ITEM = 'get_artist_item';
export const ADD_NEW_ARTIST = 'add_new_artist';
export const UPDATE_ARTIST_STARRED_STATUS = 'UPDATE_ARTIST_STARRED_STATUS';
export const GET_ARTIST_FOLDER_LIST = 'GET_ARTIST_FOLDER_LIST';
export const UPDATE_ARTIST_DETAIL = 'UPDATE_ARTIST_DETAIL';
export const UPDATE_ARTIST_LABEL = 'UPDATE_ARTIST_LABEL';
export const NULLIFY_ARTIST = 'nullifyArtist';
...
// artist heir
export const ADD_NEW_HEIR = 'ADD_NEW_HEIR';
export const GET_HEIR_INFO = 'GET_HEIR_INFO';
export const UPDATE_HEIR_INFO = 'UPDATE_HEIR_INFO';
// artist songs
export const GET_ARTIST_SONGS = 'GET_ARTIST_SONGS';
export const CREATE_ARTIST_SONG = 'CREATE_ARTIST_SONG';
export const GET_ARTIST_SONG_DETAIL = 'GET_ARTIST_SONG_DETAIL';
export const UPDATE_ARTIST_SONG = 'UPDATE_ARTIST_SONG';
export const DELETE_ARTIST_SONG = 'DELETE_ARTIST_SONG';
// repertory
export const GET_SONG_LIST = 'GET_SONG_LIST';
export const SET_SONG_DATA = 'SET_SONG_DATA';

export const GET_ALL_SONG_LIST = 'GET_ALL_SONG_LIST';
export const CREATE_NEW_SONG = 'CREATE_NEW_SONG';
export const EDIT_SONG = 'EDIT_SONG';

export const SET_NEWS_VIEW_TYPE = 'set_news_view_type';
