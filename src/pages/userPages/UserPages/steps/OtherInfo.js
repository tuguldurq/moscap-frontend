...
const OtherInfo = () => {
  ...
  return (
    <>
      ...
      <Form.List name={['affiliation', 'manager-list']}>
        {(fields, {add, remove}) => (
          <>
            {fields.map((field) => (
              <div key={field.key}>
                <div
                  ...
                  <Row gutter={12}>
                    <Col sm={8} xs={24}>
                      <Form.Item
                        label={messages['common.managerName']}
                        name={[field.name, 'name']}
                        className='form-field'>
                        <Input placeholder={messages['common.managerName']} />
                      </Form.Item>
                    </Col>
                    <Col sm={8} xs={24}>
                      <Form.Item
                        label={messages['common.managerEmail']}
                        ...
                        <Input
                          type='email'
                          placeholder={messages['common.managerEmail']}
                        />
                      </Form.Item>
                    </Col>
                    <Col sm={8} xs={24}>
                      <Form.Item
                        label={messages['common.managerPhone']}
                        name={[field.name, 'phone']}>
                        <InputNumber
                          style={{width: '100%'}}
                          placeholder={messages['common.managerPhone']}
                        />
                      </Form.Item>
                    </Col>
                  </Row>
